...
if __name__ == "__main__":
    # Generate markdown of the last codebase (this works)
    files_to_include = [
        'src/**/*',  # Incl all files in src & subdirs
        'public/index.html',
    ...
    last_code = generate_markdown(files_to_include)

    
    # save the system prompt to a file (works but without variable data)
    with open('dev-ai/data/last_system.md', 'w', encoding='utf-8') as md_file:
        md_file.write(last_code)
    print("Markdown document generated successfully: dev-ai/data/last_system.md")
